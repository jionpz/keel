 ...
 *   run-task <taskId> [--max-steps N] [--ci passed|failed|real] [--model <id>] [--harness omp|claude]
 *   status <taskId> [--events N]
 *   register-repo <remoteUrl> [--default-branch <name>]
 *   ingest-issue <issueUrl> [--label <name>] [--repo <uuid>]
 *   run-issue <issueUrl> [--label <name>] [--max-steps N] [--ci passed|failed|real] [--model <id>] [--harness omp|claude]
 */
...
命令:
  ...
  run-task <taskId> [--max-steps N] [--ci passed|failed|real] [--model <id>] [--harness omp|claude]   驱动单 task 到终态
  ...
  run-issue <issueUrl> [--label <name>] [--max-steps N] [--ci passed|failed|real] [--model <id>] [--harness omp|claude]   Issue → task → 驱动到终态
